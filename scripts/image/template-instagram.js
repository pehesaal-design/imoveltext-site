...
:root { --navy: #0b1828; --gold: #c8991f; --gold-light: #deb84a; --white: #ffffff; }
html, body { width: 1080px; height: 1350px; overflow: hidden; background: #0b1828; font-family: 'Montserrat', sans-serif; }
...
.hero-content { position: absolute; top: 0; left: 0; right: 0; padding: 48px 60px 0; text-align: center; }
.label-residencial { font-size: 18px; font-weight: 600; letter-spacing: 9px; text-transform: uppercase; color: var(--gold-light); margin-bottom: 14px; }
.title-villa { font-size: 72px; font-weight: 900; line-height: 0.95; letter-spacing: -2px; text-transform: uppercase; margin-bottom: 24px; }
...
.middle { flex: none; height: 340px; display: grid; grid-template-columns: 1fr 2px 1fr; padding: 36px 46px 28px; gap: 0; background: var(--navy); }
.div-v { background: linear-gradient(to bottom, transparent, var(--gold) 15%, var(--gold) 85%, transparent); opacity: 0.45; margin: 0 6px; }
.tag { display: inline-block; background: var(--gold); color: var(--navy); font-size: 13px; font-weight: 800; letter-spacing: 1.5px; text-transform: uppercase; padding: 7px 18px; border-radius: 3px; margin-bottom: 20px; }
...
.invest-head { font-size: 34px; font-weight: 900; line-height: 1.12; text-transform: uppercase; }
.invest-head .g { color: var(--gold-light); }
.price-block { margin: 0 38px 16px; border: 2.5px solid var(--gold); border-radius: 8px; padding: 18px 36px; text-align: center; background: linear-gradient(135deg, #0e1f38 0%, #0b1828 100%); flex-shrink: 0; }
...
.price-value { font-size: 72px; font-weight: 900; color: var(--white); line-height: 1; letter-spacing: -2px; margin-bottom: 10px; }
.price-div { height: 2px; background: linear-gradient(to right, transparent, var(--gold), transparent); }
.footer { background: var(--navy); border-top: 2px solid rgba(200,153,31,0.3); display: grid; grid-template-columns: repeat(4, 1fr); padding: 24px 30px; gap: 6px; flex: 1; align-content: center; }
.foot-item { display: flex; flex-direction: column; align-items: center; gap: 10px; text-align: center; }
.foot-icon { width: 38px; height: 38px; color: var(--gold-light); }
.foot-label { font-size: 10px; font-weight: 700; letter-spacing: 1px; text-transform: uppercase; color: var(--white); line-height: 1.5; opacity: 0.9; word-break: break-word; }
...
<div class="flyer">
  ...
  <div class="middle">
    <div class="col-left">
      ...
      <ul class="feat-list">
        ${dados.quartos ? `<li class="feat-item"><svg class="feat-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg><span class="feat-text">${dados.quartos} Quartos</span></li>` : ''}
        ${dados.suites ? `<li class="feat-item"><svg class="feat-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20 9V7a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2v2"/><path d="M2 11v5a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-5a2 2 0 0 0-4 0v2H6v-2a2 2 0 0 0-4 0z"/></svg><span class="feat-text">${dados.suites} Suítes</span></li>` : ''}
        ${dados.area ? `<li class="feat-item"><svg class="feat-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="18" height="18" rx="1" stroke-dasharray="3 2"/></svg><span class="feat-text">${dados.area}m² de Área Privativa</span></li>` : ''}
